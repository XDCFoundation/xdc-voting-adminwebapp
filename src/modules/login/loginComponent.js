...
function LoginForm(props) {
  ...
  const login = async () => {
    ...
    const [error, authResponse] = await Utils.parseResponse(
      new AuthService().signin(emailValid, passwordValid)
    );
    ...
    <div className="main-div">
      ...
      <div className="login-center">
        <div className="login-div">
          ...
          <div style={{ marginLeft: "20px", color: "red", marginTop: "-7px" }}>
            {emailError}
          </div>
          <div className="heading">
            <p>Password</p>
