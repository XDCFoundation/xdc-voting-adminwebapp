    ...
    if (window.xdc) {
      ...
      try {
        ...
        const accounts =window.web3.eth.getAccounts().then((accounts) => {
          ...
          if (
            superadmin.replace("xdc", "0x").toLocaleLowerCase() ==
            ...
            >
              ...
              <DialogContent>
                <DialogContentText className={classes.deleteconfirmation}>
                  Once an address is deleted, it cannot be readded. It is a
                  permanent removal.
                </DialogContentText>
              </DialogContent>
            ...
            >
              ...
              <div className="checked-down">
                ...
                <span className="checkbox-heading">
                  ...
                  <div className="checkbox-des">
                    By selecting this, you are permitting the address to create
                    a proposal
                  </div>
                </span>
              </div>
